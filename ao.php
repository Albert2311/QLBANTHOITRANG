    ...
    <div class="container1">
      ...
      <div class="slide active">
        <div class="info">
          <div class="info-content">
            <h2 class="top-down trans-delay-0-2">
              Áo peplum <br> tay phồng
            </h2>
            <p class="top-down trans-delay-0-4">
              Sản phẩm thể hiện lên sự sang trọng, thanh lịch. Phù hợp cho trang 
              phục công sở và tiệc nhẹ với chất liệu là vải bố sợi linen đem lại cảm
              giác thoải mái khi mặc.
            </p>
        ...
        <div class="img top-down">
          <img src="images/AO1.2-removebg-preview.png" width="60%" alt="">
        </div>
      </div>
    <!-- end slide item -->
    <!-- slide item -->
      <div class="slide">
        <div class="info">
          <div class="info-content">
            ...
            <p class="top-down trans-delay-0-4">
              Sản phầm với những đặc tính cổ điển, nữ tính, trẻ trung, nó phù hợp cho
              việc dạo phố hay đi tiệc, với chất liệu vãi cotton có khả năng hút ẩm,
              thấm mồ hôi giảm nhiệt, mang lại sự thoải mái cho người mặc.
            </p>
            <div class="top-down trans-delay-0-6">
              <a href="#banchay">
                <button class="btn-flat btn-hover">
        ...
        <div class="img right-left pad">
          <img src="images/AO9.0-removebg-preview (1).png" width="60%" style="padding-bottom:0%" alt="">
        </div>
      </div>
    <!-- end slide item -->
    <!-- slide item -->
      <div class="slide">
        <div class="info">
          <div class="info-content">
            ...
            <p class="top-down trans-delay-0-4">
              Sản phẩm mang đặc tính năng động, trẻ trung và hiện đại nên phù hợp mặc
              lúc dạo phố, với chất liệu là thun Rib-knit tạo cảm giác thông thoáng mát
              mẻ khi mặc.
            </p>
            <div class="top-down trans-delay-0-6">
              <a href="#banchay">
        ...
        <div class="img left-right padd">
          <img src="images/AO5.1-removebg-preview.png" width="60%" style="padding-bottom:0%" alt="">
        </div>
      </div>
  <!-- end slide item -->
    </div>
...
<!-- SẢN PHẨM 1 -->
  ...
  $result = mysqli_query($conn, "SELECT * FROM product WHERE type = 'Áo' " );
         ...
         <img src="images/<?php echo $row['image2'];?>" alt="">
          ...
          <div class="product-card-info">
            ...
            <a href="detail.php?id=<?php echo $row['id']?>">
              ...
              <button onclick="Toggle9()" id="btnh9" class="btn-flat1 btn-hover1 btn-cart-add">
...
<script>
  function filter_price(price){
    var xhttp = new XMLHttpRequest();
        ...
        var path = "";
        if(price == -1){
          path = `showprice_ao.php?all`; 
        }
        else if(price < 1000000){
          path = `showprice_ao.php?duoi=${price}`;
        }   else{
          path = `showprice_ao.php?tren=${price}`;
        }
...
<script>
  function filter_name(name){
    var xhttp = new XMLHttpRequest();
        ...
        var path = "";
        if(name == 'all'){
          path = `showname_ao.php?all`; 
        }
        else{
          path = `showname_ao.php?name=${name}`;
        }
        xhttp.open("GET", path, true);
        xhttp.send();
      ...
      <section class="col-12" id="fs_time_body">
          ...
          <div class="contents">
              <ul>
                  <li>
                      <span>Croptop</span>
                      <input onclick='filter_name(this.value)'  type="radio" name="filter_name" value="Croptop" class="text-right"></input>
                  </li>
                  <li>
                      <span>Áo thun</span>
                      <input onclick='filter_name(this.value)'  type="radio" name="filter_name"  value="Áo thun" class="text-right"></input>
                  </li>
                  <li class="active1">
                      <span>Áo sơ mi</span>
                      <input onclick='filter_name(this.value)'  type="radio" name="filter_name" value="Áo sơ mi" class="text-right"></input>
                  </li>
                  <li class="active1">
                      <span>Áo khoác</span>
                      <input onclick='filter_name(this.value)'  type="radio" name="filter_name" value="Áo khoác" class="text-right"></input>
                  </li>
                  <li class="active1">
                      <span>Áo kiểu</span>
                      <input onclick='filter_name(this.value)' type="radio" name="filter_name" value="Áo kiểu" class="text-right"></input>
                  </li>
                  <li class="active1">
                      <span>Áo Blazer</span>
                      <input onclick='filter_name(this.value)' type="radio" name="filter_name" value="Áo Blazer" class="text-right"></input>
                  </li>
                  <li class="active1">
                      <span>Tất cả</span>
