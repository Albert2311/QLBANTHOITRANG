<div class="row" id="banchay">
  ...
  else if(isset($_GET['duoi'])){
      $result = mysqli_query($conn, "SELECT * FROM product WHERE price < {$_GET['duoi']} AND type = 'Áo' " );
  }else{
  $result = mysqli_query($conn, "SELECT * FROM product WHERE price >= {$_GET['tren']} AND type = 'Áo' " );
  }
